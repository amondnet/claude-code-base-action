...
const PIPE_PATH = process.env.INPUT_PIPE_PATH ?? "/tmp/claude_prompt_pipe";
const EXECUTION_FILE = process.env.INPUT_EXECUTION_FILE ?? "/tmp/claude-execution-output.json";
